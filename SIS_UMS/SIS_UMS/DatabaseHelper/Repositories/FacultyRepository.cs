...
namespace SIS_UMS.DatabaseHelper.Repositories
{
    public class FacultyRepository: IFacultyRepository
    {
        ...
        public IEnumerable<Faculty> GetAllFaculties(int campus_id)
        {
        ...
        public bool CreateFaculty(Faculty faculty)
        {
            ...
            command.Parameters.AddWithValue("@p_campus_id", faculty.campus_id);
            command.Parameters.AddWithValue("@p_dean_user_id", faculty.dean_user_id);
            command.Parameters.AddWithValue("@p_faculty_name", faculty.faculty_name);
            command.Parameters.AddWithValue("@p_faculty_phone_number", faculty.faculty_phone_number);
            command.Parameters.AddWithValue("@p_faculty_uni_email", faculty.faculty_uni_email);
